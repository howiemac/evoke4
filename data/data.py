...
class DataObject(object):
    ...
    def update(self, args):
        ...
        x = [
            setattr(self, k, v) for k, v in args.items() if k in self._v_fields
        ]
    ...
    """
        ...
        if not sql:
            ...
            likes = ob.quoted_pairs(
                like.items(), op='like').replace(',', ' and ')
    ...
    # sql overrides all other parameters except sqlargs
        if sql:
            ...
            #except TypeError:
                ...
                print "data.list unmatched arguments. There are %d arguments." % len(
                    sqlargs)
                print sql
                print sqlargs
